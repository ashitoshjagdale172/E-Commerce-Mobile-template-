  ...
  return (
    <div>
      <div>
        ...
        <div className=" text-[28px] font-[800] text-[#D62828] flex flex-col items-center justify-center ">
        ...
        <div className="flex justify-center mx-6 mt-[5%]"><img src={mobiles} alt="" className="h-[220px] w-[79%]" /></div>
        <div className="mt-[10%] flex relative mb-[10%]">
            <div className=" w-[440px] h-[440px] bg-[#003049] absolute ml-[60%] z-[-1] "></div>
            <div className=" w-[70%] h-[375px] bg-[#EDF2F4] mt-[2.2%] ml-[10%] rounded-[20px] grid grid-cols-6">
